...
void onlinePlotter(){
	...
	string plotNames1d[kNUM1DPLOTS] = {"TR","R#frac{dtrack}{dR}","R#frac{dgR}{dR}","R#frac{dbR}{dR}",
		"T#frac{dtrack}{dpT}"};
	string plotXNames1d[kNUM1DPLOTS] = {"truth R","truth R","truth R","truth R","truth #Sigma track pT"};
